...
var lyr_INC_sessionsINC_1 = new ol.layer.Vector({
                ...
                popuplayertitle: "INC_sessions — INC",
                interactive: true,
...
lyr_INC_sessionsINC_1.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'INC Sessions_S.No.': '', 'INC Sessions_Year': '', 'INC Sessions_Name of the Place': '', 'INC Sessions_President': '', });
